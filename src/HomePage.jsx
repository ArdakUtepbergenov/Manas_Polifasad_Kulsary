        ...
        <div className="max-w-[1200px]">
          ...
          <Reveal delay={180}>
            <p className="mt-8 max-w-xl text-[17px] md:text-[19px] leading-[1.55] text-white/75">
              Производим и монтируем премиальные фасадные системы для частных домов, коттеджей, ресторанов и коммерческих зданий в Атырау. Архитектурное качество, гарантия 5 лет.
            </p>
          </Reveal>
          <Reveal delay={260}>
